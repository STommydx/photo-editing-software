...
public:
    ...
    FilterEffect(const QString &name, EffectFunction effect, int maxSize, double normFactor);
    FilterEffect(const QString &name, std::function<QImage(const QImage &, int)> effect, int maxSize);
...
private:
    ...
    FilterEffect(const QString &name, EffectFunction effect, int maxSize, double normFactor, bool sizeOption, bool strengthOption);
